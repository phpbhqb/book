						...
						<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
							...
							<tr>
								<td><table width="0" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											<td width="25"><img src="/empire/e/data/images/mod/center_1.gif" width="25" height="24" /></td>
											<td background="/empire/e/data/images/mod/box_1.gif">&nbsp;</td>
											<td width="25"><img src="/empire/e/data/images/mod/center_2.gif" width="25" height="24" /></td>
										</tr>
										<tr>
											<td background="/empire/e/data/images/mod/box_4.gif">&nbsp;</td>
											<td bgcolor="#F3F3F3"><a href="/empire/e/ViewImg/index.html?url=<?=$ecms_gr[picurl]?>" target="_blank"><img border="0" src="<?=$ecms_gr[picurl]?>" class="photoresize" /></a></td>
											<td background="/empire/e/data/images/mod/box_2.gif">&nbsp;</td>
										</tr>
										<tr>
											<td><img src="/empire/e/data/images/mod/center_3.gif" width="25" height="24" /></td>
											<td background="/empire/e/data/images/mod/box_3.gif">&nbsp;</td>
											<td><img src="/empire/e/data/images/mod/center_4.gif" width="25" height="24" /></td>
										</tr>
								</table></td>
							</tr>
							<tr>
