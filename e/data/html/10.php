...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>所属小说</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>顺序</td><td bgcolor='ffffff'>
<input name="sequence" type="text" id="sequence" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[sequence]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>内容详情</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("detail",$ecmsfirstpost==1?"":stripSlashes($r[detail]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>所属卷</td><td bgcolor='ffffff'>
