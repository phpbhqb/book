...
?><tr><td bgcolor=ffffff>小说名称</td><td bgcolor=ffffff><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DBEAF5">
<tr> 
...
</td></tr><tr><td bgcolor=ffffff>封面图片</td><td bgcolor=ffffff><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>小说揭示</td><td bgcolor=ffffff>
<textarea name="intro" cols="60" rows="10" id="intro"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[intro]))?></textarea>
</td></tr><tr><td bgcolor=ffffff>总字数</td><td bgcolor=ffffff>
<input name="sumword" type="text" id="sumword" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[sumword]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>是否完结</td><td bgcolor=ffffff><input name="is_complete" type="radio" value="1"<?=$r[is_complete]=="1"||$ecmsfirstpost==1?' checked':''?>>连载<input name="is_complete" type="radio" value="2"<?=$r[is_complete]=="2"?' checked':''?>>完结</td></tr>