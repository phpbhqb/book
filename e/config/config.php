...
$ecms_config['db']['dbtbpre']='b_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='TMHyw9jtcJkvtJaz3uasNM06zaVQDZBCWKeU';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='znhvr';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='vpsae';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='n7ZfIuf8XUkVgZ7vmbpIqqJOZ5uRFTmeyeC';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='WycN2e0JLRauWvgO4e4THHQ4Hk6yFwEeh3';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='r202AYEBqgPnQqV2U78nvGR5u3Q1eoLZh';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='kEUayHrVsbemvfBtEnYlSBPIIyYKgSR2';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='Ak2Fu7ljW2vSGSBLcExZvXgc2XoQC2I';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'5XTNjHmvLCAL7CwMnXkUkgmMevULCp1g',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/empire/news/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/empire/download/\">下载中心</a>&nbsp;|&nbsp;<a href=\"/empire/movie/\">影视频道</a>&nbsp;|&nbsp;<a href=\"/empire/shop/\">网上商城</a>&nbsp;|&nbsp;<a href=\"/empire/flash/\">FLASH频道</a>&nbsp;|&nbsp;<a href=\"/empire/photo/\">图片频道</a>&nbsp;|&nbsp;<a href=\"/empire/article/\">文章中心</a>&nbsp;|&nbsp;<a href=\"/empire/info/\">分类信息</a>&nbsp;|&nbsp;<a href=\"/empire/xuanhuan/\">玄幻</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'lBlhiMjWVFJ40lidBzBASX1xOwzNaDrCW8Jo',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'b7Jl1PgiJXGyXMh1v0BGbv2zqlUa01QXKR3JRTSEEb',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
$emod_pubr=Array('linkfields'=>'|book.author,author.id|chapter.bookid,book.id|');
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,author,intro,sumword,is_complete,',
'qenter'=>',',
'listtempf'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'tempf'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'cj'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'canaddf'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'caneditf'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'tbmainf'=>',title,titlepic,newstime,author,intro,sumword,is_complete,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',author,intro,sumword,is_complete,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,bookid,sequence,detail,front_level,',
'qenter'=>',',
'listtempf'=>',title,titlepic,newstime,bookid,sequence,detail,front_level,',
'tempf'=>',title,titlepic,newstime,bookid,sequence,detail,front_level,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,titlepic,newstime,bookid,sequence,detail,front_level,',
'canaddf'=>',title,titlepic,newstime,bookid,sequence,detail,front_level,',
'caneditf'=>',title,titlepic,newstime,bookid,sequence,detail,front_level,',
'tbmainf'=>',title,titlepic,newstime,bookid,sequence,detail,front_level,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',bookid,sequence,detail,front_level,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',detail,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,intro,',
'qenter'=>',',
'listtempf'=>',title,titlepic,newstime,intro,',
'tempf'=>',title,titlepic,newstime,intro,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,titlepic,newstime,intro,',
'canaddf'=>',title,titlepic,newstime,intro,',
'caneditf'=>',title,titlepic,newstime,intro,',
'tbmainf'=>',title,titlepic,newstime,intro,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',intro,',
'checkboxf'=>',',
